...
import Classes.GraphA3;
import Classes.GraphA3B;
 ...
 * @author Lwdthe1
 */
public class A3Frame3 extends JFrame implements ActionListener {
    ...
    private final int MAX_BASE_SITES = 1;
    ...
    public A3Frame3(String title, int width, int height) {
        super(title);
    ...
    public void compareBaseSiteToItsExternalSites(String baseUrlString) {
        ...
        for (String externalLinkUrlString : externalLinks) {
            ...
            mResultsTextArea.setText(LMeths.formatS("%d Edges Created from %s", 
                    progressCounter, baseUrlString) );
        }
    }
    ...
    private void loadInEdges(){
        ...
        if( mComparedEdges!=null ){
            ...
            System.out.println("\n##OUT DEGREES: \n" + mSitesGraph.outDegrees());
            System.out.println("\n##IN DEGREES: \n" + mSitesGraph.inDegrees());
        }
