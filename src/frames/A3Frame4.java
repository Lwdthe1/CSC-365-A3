 ...
 * @author Lwdthe1
 */
public class A3Frame4 extends JFrame implements ActionListener {

    public static final String EDGES_FILE_NAME = "edgesA3C.txt";
    ...
    public A3Frame4(String title, int width, int height) {
        super(title);
